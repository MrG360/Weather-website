...
class RightWeather extends React.Component{
    returnSun =(val)=>{
        ...
        return "0"+value.getHours()+":"+value.getMinutes()+":"+value.getSeconds();
        ...
        return(
            <div className="wrapper right">
                <div className="div-right-content">
                    ...
                    <div><h4>Wind : {this.props.wind} km/hr</h4> </div>
                </div>
                <div className="div-right-content">
                    <div><h4>Humidity : {this.props.humidity}%</h4>  </div>
                    <div><h4>Pressure : {this.props.pressure} Pa</h4> </div>
                </div>
                <div className="div-right-content">
                    <div><h4>Max temperature : {this.props.maxTemp}<sup>o</sup>C</h4>  </div>
                    <div><h4>Min Temperature : {this.props.minTemp}<sup>o</sup>C</h4> </div>
                </div>
                <div className="div-right-content">
                    <div><h4>Sunrise : {this.returnSun(this.props.sunrise)}</h4>  </div>
                    <div><h4>Sunset : {this.returnSun(this.props.sunset)}</h4> </div>
                </div>
            </div>
        );
    }
